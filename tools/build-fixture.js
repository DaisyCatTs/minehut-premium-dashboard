...
<!-- REAL captured server card, hibernating, pasted from the live dashboard.
     Kept verbatim except the icon src, which points at S3 and would make the
     fixture hit the network. This is the variant that ships
     hover:text-[var(--mh-brand)] on the copy button — the fixture's older
     capture uses hover:text-foreground, and BOTH are in the bundle, so both
     have to be restated in section 72. -->
<article class="relative flex h-full flex-col overflow-hidden rounded-[10px] border border-border bg-card transition-[border-color,box-shadow] duration-200 hover:border-[color-mix(in_oklab,var(--mh-brand)_45%,transparent)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.35)]" style="max-width:420px;margin-bottom:24px"><div aria-hidden="true" class="absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-[var(--mh-diamond)] to-[var(--mh-brand)] opacity-60"></div><div class="grid grid-cols-[auto_1fr_auto] items-start gap-4 px-6 pb-4 pt-6"><a aria-label="Bleed" class="rounded-[10px]" href="#"><div class="relative size-12 shrink-0"><div class="grid size-full place-items-center overflow-hidden rounded-[10px] bg-[var(--mh-bg-3)] shadow-[inset_0_1px_0_rgba(255,255,255,0.05),0_2px_8px_rgba(0,0,0,0.3)] brightness-75 saturate-[0.3]"><img alt="" width="48" height="48" class="size-full object-cover [image-rendering:pixelated]" src="data:image/gif;base64,R0lGODlhAQABAIAAAKppRgAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" style="color: transparent;"></div><span aria-hidden="true" class="absolute -bottom-1 -right-1 size-3.5 rounded-full border-[2.5px] border-card bg-muted-foreground opacity-70"></span></div></a><div class="min-w-0"><h3 class="m-0 text-[16px] font-semibold leading-tight tracking-[-0.01em] text-muted-foreground "><a class="align-middle hover:underline" href="#">Bleed</a></h3><button type="button" aria-label="Copy bleed.minehut.gg" title="Copy bleed.minehut.gg" class="mt-1 inline-flex items-center gap-1.5 font-mono text-[12px] text-muted-foreground transition-colors hover:text-[var(--mh-brand)] "><span>bleed.minehut.gg</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="lucide lucide-copy size-3 opacity-70"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"></rect><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"></path></svg></button></div><span class="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap rounded-full px-2 py-[3px] font-mono text-[10px] font-semibold uppercase tracking-[0.08em] bg-muted text-muted-foreground"><span class="size-1.5 rounded-full bg-current "></span>Hibernating</span></div><div class="grid grid-cols-2 gap-4 border-t border-dashed border-border px-6 py-4"><div class="min-w-0"><div title="Starter" class="truncate font-mono text-[18px] font-medium leading-[1.1] tracking-[-0.02em] text-muted-foreground">Starter</div><div class="mt-1.5 font-mono text-[10px] font-medium uppercase tracking-[0.1em] text-muted-foreground">Plan</div></div><div class="min-w-0"><div title="Today" class="truncate font-mono text-[18px] font-medium leading-[1.1] tracking-[-0.02em] text-muted-foreground">Today</div><div class="mt-1.5 font-mono text-[10px] font-medium uppercase tracking-[0.1em] text-muted-foreground">Last online</div></div></div><div class="mt-auto px-6 pb-6 pt-4"><div class="grid grid-cols-2 gap-2"><button type="button" class="inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-[var(--mh-brand)] bg-[var(--mh-brand)] px-3 py-2 text-[12.5px] font-medium text-[var(--mh-on-brand)] shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] transition-colors hover:bg-[var(--mh-brand-hover)] hover:border-[var(--mh-brand-hover)]"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="0" class="lucide lucide-play size-3.5"><polygon points="6 3 20 12 6 21 6 3"></polygon></svg>Activate</button><a class="inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md border border-border bg-card px-3 py-2 text-[12.5px] font-medium text-foreground transition-colors hover:border-[hsl(var(--foreground)/0.2)] hover:bg-muted" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="lucide lucide-settings size-3.5"><circle cx="12" cy="12" r="3"></circle></svg>Manage</a></div></div></article>
